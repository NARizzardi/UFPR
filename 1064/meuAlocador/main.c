...
extern void *topo_inicial_heap;	/* Você precisa ter a variável global que armazena o valor de brk como um extern aqui.
							No código de teste estou chamandando de topo_inicial_heap, mas se utilizarem outro nome,
